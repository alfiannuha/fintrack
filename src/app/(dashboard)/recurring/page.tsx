      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-pink-500 to-rose-500 p-4 md:p-6 text-white shadow-xl">
          ...
          <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <h1 className="text-xl md:text-2xl font-bold">Transaksi Berulang</h1>
              <p className="text-white/80 text-xs md:text-sm mt-1">Otomatis catat transaksi rutin setiap bulan</p>
            </div>
              ...
              <DialogContent className="sm:max-w-md">
                ...
                <form onSubmit={handleCreateRule} className="space-y-5">
                  ...
                  <DialogFooter className="flex flex-row gap-3">
                    ...
                    <Button type="submit" className="flex-1 rounded-lg bg-gradient-to-r from-pink-500 to-rose-500 hover:from-cyan-600 hover:to-blue-600 font-semibold">
                      💾 Simpan
                    </Button>
                  </DialogFooter>
                </form>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {rules.map((rule) => (
              <Card key={rule._id} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                <div className={`h-1 ${rule.is_active ? 'bg-gradient-to-r from-pink-500 to-rose-500' : 'bg-slate-300 bg-slate-600'}`} />
