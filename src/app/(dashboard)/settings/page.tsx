  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 animate-fade-in">
        {/* Header */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-700 to-slate-900 p-4 md:p-6 text-white shadow-xl">
          ...
          <div className="relative">
            ...
            <p className="text-white/80 text-xs md:text-sm mt-1">Kelola akun dan preferensi Anda</p>
          </div>
        </div>
