...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 border-t border-border bg-background/80 backdrop-blur-xl md:hidden z-50 cursor-pointer">
      ...
      <aside className="hidden md:flex fixed left-0 top-0 bottom-0 w-64 border-r border-border bg-card/80 backdrop-blur-xl z-50 flex-col">
        ...
        <div className="p-3 border-t border-border/50">
          <div className="relative p-3 rounded-xl bg-gradient-to-br from-pink-500/10 via-rose-500/5 to-transparent border border-border/50 overflow-hidden cursor-pointer">
